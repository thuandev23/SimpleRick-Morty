package com.thuan.network.models

import com.thuan.network.models.domain.*
import com.thuan.network.models.remote.*
...
class KtorClient {
    ...
    private var characterCache = mutableMapOf<Int, Character>() //  cache để giảm số lần gọi API không cần thiết
